                                    ...
                                    @foreach($categories as $category)
                                        <li class="mb-2">
                                            <a href="{{ route('blog.category', $category->slug) }}" class="text-decoration-none d-flex justify-content-between align-items-center">
                                                ...
                                                <span class="badge bg-light text-dark">{{ $category->posts_count ?? $category->posts->count() }}</span>
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex flex-wrap gap-2">
                                    @foreach($popularTags as $tag)
                                        <a href="{{ route('blog.index', ['tag' => $tag]) }}" class="badge bg-light text-dark text-decoration-none">
                                            #{{ $tag }}
                                        </a>
                                    @endforeach
                                </div>

...
<section style="background-color: {{ $backgroundColor }};">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            {{-- Content Column --}}
            <div class="col-xl-5 col-lg-6 col-md-10 md-mb-50px text-center text-lg-start">
                @if($subtitle)
            ...
            <div class="col-lg-6 offset-xl-1 col-md-10"
                ...
                <figure class="position-relative m-0">
                    ...
                    @if($badge)
                        <div class="atropos-rotate-scroll-left position-absolute top-50px lg-top-30px right-minus-30px lg-right-0px" data-bottom-top="transform: translateY(-50px)" data-top-bottom="transform: translateY(50px)">

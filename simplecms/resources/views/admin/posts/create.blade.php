                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('workflow_status') is-invalid @enderror"
                                    ...
                                    required>
                                <option value="draft" {{ old('workflow_status', 'draft') == 'draft' ? 'selected' : '' }}>Draft</option>
                                <option value="pending_review" {{ old('workflow_status') == 'pending_review' ? 'selected' : '' }}>Pending Review</option>
                                <option value="scheduled" {{ old('workflow_status') == 'scheduled' ? 'selected' : '' }}>Scheduled</option>
                                <option value="published" {{ old('workflow_status') == 'published' ? 'selected' : '' }}>Published</option>
                                <option value="archived" {{ old('workflow_status') == 'archived' ? 'selected' : '' }}>Archived</option>
                            </select>
